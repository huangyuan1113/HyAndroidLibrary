...
import so.laji.android.ImageDataSource;
import so.laji.android.ImagePicker;
import so.laji.android.R;
import so.laji.android.activity.BaseActivity;
import so.laji.android.adapter.ImageFolderAdapter;
import so.laji.android.adapter.ImageGridAdapter;
import so.laji.android.bean.ImageFolder;
import so.laji.android.bean.ImageItem;
import so.laji.android.utils.DeviceTool;

public class ImageGridActivity extends BaseActivity implements ImageDataSource.OnImagesLoadedListener,
        ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayMetrics dm = DeviceTool.getScreenPix(this);
